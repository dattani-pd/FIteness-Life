    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildSection("PRIVACY POLICY", "", textColor, subTextColor), // Main Title
            _buildSection(
                "1. Overview",
                "Brisley (the “Trainer”, “Trainers” or “we” or “our” or “us”) is the sole proprietor and absolute owner of the application “Fitness is Life” (“Platform / App”) which enables personal trainers, wellness coaches and nutritionists to provide training and coaching to their clients using the Platform. The Trainer at sole discretion has the right to develop, make improvements and update the Platform. The App is developed and maintained by FitBudd Inc. including any of its subsidiaries (“FitBudd”)\n\n"
            ...
            _buildSection(
                ...
                "In the event that you choose to register as a user of the Platform, you will be asked to create a unique username and private password (collectively, the “Access ID”) which will be used to create and activate an account through which the Trainer can make the Platform available to you (the “Account”). You expressly acknowledge and agree that certain information such as your name, age, gender, physical health condition and email address and certain additional information (“Personal Information”) may be required by the User to make the Services available to you, or may be disclosed by you on or through the Services. In order to avail our Services, the User may be requested to upload his/her photos on the Platform to assess the fitness progress. FitBudd will store all the Personal Information in the manner as required under the Law and the Trainer will try its best endeavors to protect the disclosure of the photos uploaded on the Platform, however, shall not be liable for any disclosure to third-party (other than FitBudd) by the trainers, wellness coaches and nutritionists registered as a service providers with us.\n\n"
                    ...
                    "We collect User’s financial account numbers (including bank account numbers, payment card numbers i.e. credit card or debit card numbers, payment instrument details or other information if that information would permit access to an User’s financial account) (“Financial Information”) through our Platform and other personally identifying information only for the purposes as mentioned in the Terms of Use. However, some of our Services may require the collection of some personally identifying information, such as your name, address, contact number, etc. You may contact our representative briss.carmax@gmail.com in order to amend or rectify any Personal Information or Financial Information. You may also intimate us if you do not wish that we retain or use your Personal Information or Financial Information. However, in such a case, we may not be able to provide you some of our Services and/or access to our Platform. We may use your contact information such as email address, without further notice, to send you information about our Services, respond to your requests, or facilitate your use of the Services.\n\n"
            ...
            _buildSection(
                "6. Email",
                "In order to provide you with timely notice regarding our Services or other information, we may send you emails and/ or newsletters. At any time, you may discontinue this Service by using the link provided in the mailers itself or sending an email to briss.carmax@gmail.com requesting that your email address be removed from our lists.",
                textColor,
                subTextColor),
            ...
            _buildSection(
                "8. Contact",
                "If you have any query or grievance in relation to the use and/or protection of your personal data and/or otherwise in relation to the Platform, please contact us at briss.carmax@gmail.com",
                textColor,
                subTextColor),
      ...
      children: [
        if (title.isNotEmpty)
          Text(
            title,
            style: TextStyle(
              fontSize: title == "PRIVACY POLICY" ? 18 : 16,
              fontWeight: FontWeight.bold,
              color: titleColor,
              decoration: title == "PRIVACY POLICY" ? TextDecoration.underline : TextDecoration.none,
              decorationColor: titleColor,
            ),
          ),
        if (title.isNotEmpty && body.isNotEmpty) const SizedBox(height: 12),
        if (body.isNotEmpty)
          Text(
            body,
            style: TextStyle(
